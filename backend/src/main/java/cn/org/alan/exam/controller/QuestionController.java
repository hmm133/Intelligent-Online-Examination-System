...
public class QuestionController {
    ...
    @PreAuthorize("hasAnyAuthority('role_teacher','role_admin')")
    public Result<AIGeneratedQuestionVO> aiGenerateQuestions(
            @Validated @RequestBody AIGenerateQuestionForm form) {
        return iQuestionService.aiGenerateQuestions(form);
    }
}
