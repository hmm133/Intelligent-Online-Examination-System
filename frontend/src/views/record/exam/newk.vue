                      ...
                      <div class="qu_analysis">
                        <el-card>
                          ...
                          <div style="margin-bottom: 15px; border-bottom: 1px dashed #eee; padding-bottom: 10px;">
                            <span style="font-weight: bold; color: #606266;">本题得分：</span>
                            <span :style="{ color: index.score == index.totalScore ? '#67C23A' : '#F56C6C', fontSize: '18px', fontWeight: 'bold' }">
                              {{ index.score != null ? index.score : 0 }}
                            </span>
                            <span style="color: #909399; font-size: 14px;"> / {{ index.totalScore }} 分</span>
                          </div>
                          <div>
                          ...
                          <div style="margin-top: 8px">
                            <span style="font-weight: bold;">试题解析：</span>
                      ...
                      <div class="qu_analysis">
                        <el-card>
                          ...
                          <div style="margin-bottom: 15px; border-bottom: 1px dashed #eee; padding-bottom: 10px;">
                            ...
                            <el-tag size="mini" type="warning" style="margin-left: 10px" v-if="index.quType === 4">主观题</el-tag>
                          </div>
                          <div>
                            </div>
                          <div style="margin-top: 8px">
